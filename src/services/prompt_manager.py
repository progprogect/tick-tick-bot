...
- Найди задачу с названием "X" в этом списке
- Используй её ID в поле taskId (НЕ title!)
- Если не нашел точное совпадение, ищи похожее название (частичное совпадение)
Пример ответа:
{
  "action": "update_task",
