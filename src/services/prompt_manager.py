...
ПРИМЕРЫ КОМАНД С УКАЗАНИЕМ СПИСКА:
- "Создай задачу X в списке Работа" → {"action": "create_task", "title": "X", "projectId": "ID_ПРОЕКТА_РАБОТА_ИЗ_КОНТЕКСТА"}
- "Добавь задачу Y в проекте Личное" → {"action": "create_task", "title": "Y", "projectId": "ID_ПРОЕКТА_ЛИЧНОЕ_ИЗ_КОНТЕКСТА"}
- "Создай задачу Z в Работа" → {"action": "create_task", "title": "Z", "projectId": "ID_ПРОЕКТА_РАБОТА_ИЗ_КОНТЕКСТА"}

ВСЕГДА проверяй наличие списка в контексте перед использованием его ID!"""
